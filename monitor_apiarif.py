#!/usr/bin/env python3
"""
🎯 MONITORING DASHBOARD - APIARIF
Dashboard ringan untuk monitoring akun apiarif di port 9002
...
# Bybit API Configuration untuk apiarif
BYBIT_API_KEY = os.environ.get('BYBIT_API_KEY_APIARIF')
BYBIT_SECRET_KEY = os.environ.get('BYBIT_SECRET_KEY_APIARIF')
BYBIT_TESTNET = False
...
<head>
    ...
    <title>🎯 Monitor APIARIF - Port 9002</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎯 MONITOR APIARIF</h1>
            <p>Real-time Trading Dashboard - Port 9002</p>
        ...
        <div class="footer">
            ...
            <p>🎯 Sniper Trading Bot - APIARIF Monitor</p>
        </div>
    </div>
</body>
</html>
...
if __name__ == '__main__':
    print("🎯 Starting APIARIF Monitor on port 9002...")
